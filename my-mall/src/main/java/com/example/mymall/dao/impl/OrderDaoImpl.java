...
import com.example.mymall.dao.OrderDao;
import com.example.mymall.model.Order;
import com.example.mymall.model.OrderItem;
import com.example.mymall.rowmapper.OrderItemRowMapper;
import com.example.mymall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        String sql = "SELECT oi.order_item_id,oi.order_id,oi.product_id,oi.quantity,oi.amount,p.product_name,p.image_url FROM  order_item as oi " +
